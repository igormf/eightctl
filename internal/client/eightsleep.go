...
func (c *Client) do(ctx context.Context, method, path string, query url.Values, body any, out any) error {
	return c.doRetryWithBase(ctx, c.BaseURL, method, path, query, body, out, 0)
}

func (c *Client) doApp(ctx context.Context, method, path string, query url.Values, body any, out any) error {
	return c.doRetryWithBase(ctx, c.AppURL, method, path, query, body, out, 0)
}

func (c *Client) doRetryWithBase(ctx context.Context, baseURL, method, path string, query url.Values, body any, out any, attempt int) error {
	...
	if resp.StatusCode == http.StatusTooManyRequests {
		...
		return c.doRetryWithBase(ctx, baseURL, method, path, query, body, out, attempt+1)
	}
